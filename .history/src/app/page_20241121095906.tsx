...
function Home() {
  ...
  return <div className="main flex h-screen">
    ...
    <div className="flex justify-center items-center h-[200px] w-[200px] bg-slate-500 border-2 border-black">Box 2</div>
    <div className=" flex justify-center items-center h-[200px] w-[200px] bg-blue-500 border-2 border-black">Box 3 </div>
    <div className="flex justify-center items-center h-[200px] w-[200px] bg-slate-500 border-2 border-black">Box 4</div>
